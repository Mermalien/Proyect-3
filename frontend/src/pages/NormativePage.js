  ...
  return (
    <main className="normativa-page">
      <div className="normativa-container">
        ...
        <section>
          ...
          <div className="normacomponent">
            <ImageComponent
              ...
              message={
                <>
                  Conoce las leyes y regulaciones locales: Es importante conocer
                  las leyes y regulaciones de tu área sobre animales de
                  compañía. Puedes revisar el{" "}
                  <a
        ...
        <Link to={"/"}>
          <p className="backtohome">Volver al inicio</p>
        </Link>
      </div>
    </main>
  );
